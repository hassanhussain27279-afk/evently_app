...
class EventMangnment extends StatefulWidget {
  const EventMangnment({super.key});
  static const String id = 'EventMangnment';

  @override
  State<EventMangnment> createState() => _EventMangnmentState();
}

class _EventMangnmentState extends State<EventMangnment> {
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomFilledButton(
                text: localizations.addEventButton,
                onPressed: () {
